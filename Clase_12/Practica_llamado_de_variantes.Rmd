...
Constará de los siguientes archivos necesarios para efectuar el llamado de variantes
...
Añadir grupos de lectura al archivo sort bam

java -jar picard.jar AddOrReplaceReadGroups I=SRR2009653.sort.bam O=SRR2009653_sorted_RG.bam ID=sample LB=Paired-end PL=Illumina PU=Unknown SM=sample

Ejecutar el siguiente comando para el llamado de variantes
