...
a) Busque el código Md5 de las muestras y direccione la información a un archivo md5_samples, con el siguiente comando:
   
    md5sum SRR2006763_1.fastq SRR2006763_2.fastq > md5_samples
    
b) Verificar la salida generada
...
1. Windows mediante Winscp u otro 

3. MAC: se puede crear un directorio temporal para la descarga de archivos
...
a) Entrar a la carpeta donde constan los archivos fastq y ejecutar el siguiente script

    #!/bin/bash
    #SBATCH - J trimm01
    trimmomatic PE SRR2006763_1.fastq SRR2006763_2.fastq -baseout SRR20067634_filtered.fastq.gz SLIDINGWINDOW:5:25 MINLEN:60

b) De la ejecución anterior, resultarán 4 archivos comprimidos como se detalla a continuación
...
c) Descomprimir los archivos con

    unzip SRR20067634_filtered_1P.fastq.gz

d) Volver a realizar un análisis de calidad de las muestras y comparar con el reporte de calidad inicial (en un script o directamente en la terminal)
