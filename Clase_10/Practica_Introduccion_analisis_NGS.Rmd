...
En esta práctica aprenderemos a realizar el análisis de calidad de datos de secuenciación masiva. Recordemos que las plataformas son susceptibles a una amplia gama de fallas químicas e instrumentales (Stephan et al., 2014), por lo que, los datos obtenidos pueden tener un fuerte ruido de fondo, contaminación de los adaptadores, baja calidad de secuenciación u otros (He et al., 2020).

Por ello, el control de calidad, en el preprocesamiento de datos, se torna esencial, a fin de contar con datos limpios para evitar fallas en la detección de variantes o regiones genómicas objeto de análisis posteriores.

Con este objetivo, ocuparemos el software **fastqc** y lecturas crudas obtenidas por secuenciación de extremos emparejados con Illumina HiSeq2000 de la cepa Aquagen de _Salmo salar_, a partir de un estudio de resistencia a la necrosis pancreática infecciosa.
