...
Al finalizar la ejecución listar la carpeta SRA_samples para comprobar que se creó el directorio de la secuencia descargada con el nombre **SRR2006763**
...
a) Busque el código Md5 de las muestras en NCBI.
    ...
    md5sum SRR2006763_1.fastq
    md5sum SRR2006763_2.fastq

Códigos:

fq_1: dd0bdf8c722226ea34611941f2391774
fq_2: 1c63ca4a6e14de4f93f7621e3e990ec9

c) Compruebe la integridad de ambas biomuestras usando md5sum o similar.
...
1. Windows mediante Winscp 
2. MAC: se puede crear un directorio temporal para la descarga de archivos
- Colocar en la terminal `cd tmp` 
- Crear un directorio `mkdir download`
- Ingresar al directorio `cd download`
- Ejecutar línea de comando para copia segura de documentos
  
       scp usuario@200.54.220.141:/home2/usuario/SRA_samples/SRR2006763/*.html .
       
 - Se solicitará el ingreso de la clave
 - Se concluirá la descarga al computador local y se la puede revisar con `open .`
 - Visualizar archivos generados

## 6 - FILTRADO Y PODA

Entrar a la carpeta donde constan los archivos fastq y ejecutar el siguiente script

    #!/bin/bash
    #SBATCH - J trimm01
    trimmomatic PE --phred33 SRR2006763_1.fastq SRR2006763_2.fastq output_forward_paired.fq.gz \
    trimmomatic PE --phred33  /home2/mrivera/SRA_samples/SRR2006763/SRR2006763_1.fastq  /home2/mrivera/SRA_samples/SRR2006763/SRR2006763_2.fastq -baseout  /home2/mrivera/SRA_samples/SRR2006763/SRR2006763_filtered.fq.gz 
