...
Para efectuar el control de calidad se han desarrollado diversas herramientas bioinformáticas siendo una de las primeras y más populares **FastQC** [(Andrews, 2010)](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/), un software compatible con las principales plataformas de secuenciación, pero usada preferentemente con datos de secuenciación Illumina. 
