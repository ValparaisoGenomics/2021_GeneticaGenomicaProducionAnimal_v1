...
Instalar los softwares samtools y bwa:

    conda install -c bioconda samtools
    conda install -c bioconda bwa
    
Es probable que cuando realices la instalación de samtools se presente un error común en los canales, si es el caso, puedes corregirlo colocando individualmente los siguientes comandos en la terminal: 
...
En la clase de análisis de calidad y poda de datos se obtuvieron los archivos filtrados de las secuencias en formato comprimido con los nombres:  

_SRR20067634_filtered_1P.fastq.gz_
_SRR20067634_filtered_2P.fastq.gz_
_SRR20067634_filtered_1U.fastq.gz_
_SRR20067634_filtered_2U.fastq.gz_

Para el alineamiento, el program BWA admite los formatos fastq o fastq.gz, de tal forma que puedes trabajar con tus archivos filtrados o, para este caso, considerando que nuestras secuencias fastq originales tuvieron muy buena calidad, puedes trabajar directamente con ellas. Para ambos casos debes trasladar los archivos a una nueva carpeta, así:
...
[genoma_m] (https://www.ncbi.nlm.nih.gov/genome/?term=salmo+salar)
...
![Reference genome](https://user-images.githubusercontent.com/80792310/122258111-4d2ad100-ce96-11eb-82fc-8857359e7e6a.png)
