...
![image](https://user-images.githubusercontent.com/80792310/121112439-05d97c00-c7d6-11eb-8816-961022673034.png)
...
Colocar las secuencias fastq para su alinemkento
 
Descargar el genoma de referencia del organismo _Salmo salar_

### 4 - INDEXACION DEL GENOMA DE REFERENCIA

    bwa index GCF_000233375.1_ICSASG_v2_genomic.fna
...
Trabajaremos con el algoritmo mem del programa BWA, "mem"

BWA-MEM se recomienda para secuencias de consulta de más de ~ 70 pb para una variedad de tasas de error (o divergencia de secuencia). Generalmente, BWA-MEM es más tolerante con los errores dadas las secuencias de consulta más largas, ya que la posibilidad de perder todas las semillas es pequeña. Como se muestra arriba, con configuraciones no predeterminadas, BWA-MEM funciona con lecturas Oxford Nanopore con una tasa de error de secuenciación superior al 20%. 
